...
namespace QuanLiThuVien.Controllers
{
    public class QLDGController : Controller
    {
        ...
        public string PhatSinhTenHinhAnh(QLThuVienEntities4 ql)         //phat sinh ten hinh anh cho anh doc gia trong bang chinh
        {
            string masothe = "";
        ...
        { 
            ...
            string masothe = PhatSinhTenHinhAnh(ql);                //phat sinh ten hinh anh / ma cua doc gia moi
        ...
        {       
            var data = from dg in ql.tbl_DocGia
        ...
        {
            //QLThuVienEntities1 ql = new QLThuVienEntities1();
            List<tbl_DocGia> t = (from e in ql.tbl_DocGia select e ).ToList();
        ...
        {     
            tbl_DocGia t = (from e in ql.tbl_DocGia where e.ID==id select e).First();
            return View(t);
        }
    }
}
